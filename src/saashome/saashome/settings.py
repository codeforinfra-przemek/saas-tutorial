...
Generated by Django and maintained for the current Django 6 runtime.
...
# Environment-specific security. Local development remains convenient, while
# production defaults fail closed unless explicitly overridden.
