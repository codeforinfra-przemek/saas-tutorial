...
class Command(BaseCommand):
    ...
    def seed_franchises(self, categories, organizations):
        ...
        for item in data:
            ...
            defaults = {
                ...
                # Demo numbers must not influence public ranking or ratings.
    ...
    def additional_demo_franchises(self):
        ...
        specs = [
            ...
            ("intermarche", "Intermarche", "convenience", "https://www.intermarche.pl", "Supermarket spożywczy rozwijany w formacie lokalnego przedsiębiorcy."),
            ("spar", "SPAR", "convenience", "https://www.spar.pl", "Marka sklepów spożywczych działająca w wielu formatach lokalnych."),
            ("nasz-sklep", "Nasz Sklep", "convenience", "https://www.naszsklep.pl", "Format niezależnego sklepu spożywczego pod wspólnym szyldem."),
            ("piekarnia-grzybki", "Piekarnia Grzybki", "convenience", "https://www.grzybki.pl", "Piekarniczo-cukierniczy format punktu sprzedaży lokalnej."),
            ("sphinx", "Sphinx", "gastronomia", "https://sphinx.pl", "Restauracyjny koncept casual dining z rozpoznawalną marką."),
            ("pizzeria-biesiadowo", "Pizzeria Biesiadowo", "gastronomia", "https://biesiadowo.pl", "Pizzeria z ofertą dla gości lokalu i dostaw."),
            ("koku-sushi", "Koku Sushi", "gastronomia", "https://kokusushi.pl", "Restauracyjny format sushi i dań kuchni azjatyckiej."),
            ("bobby-burger", "Bobby Burger", "gastronomia", "https://bobbyburger.pl", "Miejski koncept burgerowy w segmencie szybkiej gastronomii."),
            ("czas-na-herbate", "Czas na Herbatę", "gastronomia", "https://czasnaherbate.net", "Sklep specjalistyczny z herbatą, kawą i akcesoriami."),
            ("bricks-4-kidz", "Bricks 4 Kidz", "edukacja", "https://www.bricks4kidz.com", "Zajęcia edukacyjne dla dzieci oparte o kreatywną pracę z klockami."),
            ("akademia-bystrzak", "Akademia Bystrzak", "edukacja", "https://bystrzak.edu.pl", "Program rozwojowy i zajęcia wspierające kompetencje dzieci."),
            ("da-vinci", "Da Vinci", "edukacja", "https://davinci.edu.pl", "Edukacyjny format zajęć rozwijających umiejętności dzieci."),
            ("code-kids", "Code Kids", "edukacja", "https://codekids.pl", "Zajęcia z programowania i technologii dla dzieci i młodzieży."),
            ("epaka", "epaka.pl", "uslugi", "https://www.epaka.pl", "Punkt usług kurierskich i obsługi przesyłek dla klientów lokalnych."),
            ("mail-boxes-etc", "Mail Boxes Etc.", "uslugi", "https://www.mbe.pl", "Usługi wysyłkowe, druk i wsparcie dla małych firm."),
            ("remax", "RE/MAX", "uslugi", "https://www.remax-polska.pl", "Biuro nieruchomości działające pod międzynarodową marką."),
            ("cleanwhale", "CleanWhale", "uslugi", "https://cleanwhale.pl", "Usługi sprzątania dla klientów indywidualnych i biznesowych."),
            ("teletorium", "Teletorium", "uslugi", "https://teletorium.pl", "Punkt sprzedaży akcesoriów i usług dla urządzeń mobilnych."),
            ("cityfit", "CityFit", "fitness", "https://cityfit.pl", "Nowoczesny format klubu fitness dostępnego dla miejskich użytkowników."),
        ]
        category_defaults = {
